...
export type Module = ModuleApi | ModuleServiceProvider;
...
export interface InterfaceRef {
  ...
  /**
   * The module in which the referenced interface is defined. This can be
   * omitted when used inside the module that defines the referenced interface
   */
  module?: ModuleRef;
}
